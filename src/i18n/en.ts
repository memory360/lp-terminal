...
export const en = {
  ...
  app: {
    wrongNetwork: '!! WRONG NETWORK — this terminal only writes on {{chain}}',
    switch: 'SWITCH',
    switchingChain: 'Switching to {{chain}}…',
    chainSwitchFailed: 'Failed to switch to {{chain}}: {{err}}',
    tagline: 'LP TERMINAL v0.2 · exact approvals · live on-chain reads',
    keys: 'keys: [1] pools [2] positions [3] swap [4] liquidity [5] bridge',
  ...
  pools: {
    ...
    thFees1h: 'FEES 1H',
    thFeeApr: 'FEE APR',
    thRangeEarnings: '±10%·$1K·FEE/H',
    rangeEarningsTip: 'Unstaked fee estimate: hourly income for a new $1,000 LP in a ±10% range using trailing 1H volume; not UP emissions',
    thRewards: 'REWARDS',
  ...
  add: {
    ...
    showLiquidity: 'VIEW LIQUIDITY',
    hideLiquidity: 'HIDE LIQUIDITY',
    liquidityTitle: 'RANGE LIQUIDITY',
    liquidityLoading: '> loading range liquidity on demand',
    liquidityError: '> failed to load range liquidity',
    liquidityRetry: 'RETRY',
    liquidityRefresh: 'REFRESH',
    liquidityPair: '{{quote}}/{{base}} price · dashed line is current price',
    priceLo: 'lower price',
    priceHi: 'upper price',
  ...
  zap: {
    zapIn: 'ZAP IN',
    usdValue: '≈ {{usd}} USDC',
    ethTip: 'native {{native}} — wrapped to {{wrapped}} as step 1',
    slip: 'SWAP SLIP',
  ...
  pos: {
    ...
    stakeAdvice: {
      ...
      wallet: 'STAKING NOT RECOMMENDED',
      similar: 'YIELDS ARE SIMILAR',
      detail: '$1,000 LP / 1 hour: unstaked ≈ {{wallet}} · staked ≈ {{stake}}',
      basis: 'Estimated from this position range, trailing 24H volume, and current UP emissions; differences within 10% are treated as similar and actual yield will vary',
    },
  ...
  swap: {
    ...
    nativeWethNote: 'native route delivers {{wrapped}} (not {{native}})',
  ...
  limit: {
    ...
    unsupported: 'Range orders are not supported on this chain.',
  },
  bridge: {
